...
public class TestScrollView2 extends NestedScrollView implements GestureDetector.OnGestureListener {
    ...
    public TestScrollView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TestScrollView2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d("TestScrollView", "@@@ super.onTouchEvent: " + event.getEventTime());
...
//    }
    ...
    public boolean canScrollVertically(int direction) {
        Log.d("TestScrollView", "canScrollVertically: " + direction);
